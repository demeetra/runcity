...
export const MainLayout = () => {
  ...
  const { isSignedIn, eventId, eventPlay, inProfile } = useSelector(state => state.screenReducer);
  ...
  return (
    <View style={styles.wrapper}>
      <Navbar name='Бегущий Город' nameAction={nameAction} backAction={backAction} profileAction={profileAction} profileName={profileName}/>
